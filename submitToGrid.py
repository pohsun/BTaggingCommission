...
def submitProduction(tag,lfnDirBase,dataset,isData,cfg,workDir,lumiMask,submit=False):
    ...
    config_file.write('config.JobType.pyCfgParams = [\'useTTbarFilter=True\', \'miniAOD=True\', \'maxEvents=-1\', \'doCTag=True\', \'hipMitigation=True\', \'runIVF=True\', \'remakeAllDiscr=True\', \'runOnData=%s\']\n' % bool(isData))    
