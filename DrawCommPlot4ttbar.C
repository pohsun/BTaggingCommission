...
//TString LumititleTTBar= "218.042 pb^{-1} (13 TeV)";
//TString LumititleTTBar= "0.8 fb^{-1} (13 TeV)";
//TString LumititleTTBar= "9.2 fb^{-1} (13 TeV)";
//TString LumititleTTBar= "0.8 fb^{-1} (13 TeV)"; 
//TString LumititleTTBar= "4.4 fb^{-1} (13 TeV)"; 
//TString LumititleTTBar= "5.1 fb^{-1} (13 TeV)"; //RunEF
TString LumititleTTBar= "12.9 fb^{-1} (13 TeV)"; //RunBCD
TString Jettypetitle="AK4 jets (p_{T} > 20 GeV)";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/02May_test/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/26May_PromptReco/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/05June_589pb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/05June_589pb_pu/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/05June_589pb_puNoDYSF/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_JER/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_trgEff/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_trgEff_noJER/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_trgEff2_noJER/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_pu_71mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_trgEff2_pu71mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/06June_804pb_trgEff_pu71mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/LHCP/Run2016B_804pb_noTriggEff/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/21June_2fb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/21June_2fb_69p735mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v1/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v2/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v3/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v4/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v4_69p735mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/19July_ICHEP_9fb_v4_69mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_DataMC_HIPcheck/output_all_BCD_HIP.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_DataMC_HIPcheck/output_all_BCD_noHIP.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_DataMC_HIPcheck/output_all_EF_noHIP.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_DataMC_HIPcheck/output_all_EF_HIP.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_MC_HIP_wrtEF_65mb_brilcac/output_all.root";
TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/22Aug_MC_HIP_wrtBCD_61mb/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/26Sep_G/output_all.root";
//TString filename="/Users/Alpha/myAna/BTagging/RecoBTag-PerformanceMeasurements/test/BTagAnalyzerMacros/results/26Sep_G_bad/output_all.root";
TString CMStitle= "CMS";
TString Preliminarytitle= "Preliminary";
TString Selectiontitle= "e#mu channel, #geq 2 jets";
//TString Lumititle= "0.8 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
//TString Lumititle= "4.4 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
//TString Lumititle= "5.1 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
TString Lumititle= "12.9 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
//TString Lumititle= "9.2 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
//TString Lumititle= "0.8 fb^{-1}, #sqrt{s} = 13 TeV, 2016";
//TString Lumititle= "#sqrt{s} = 13 TeV, 25ns";
//TString outputPath="./results/26Sep_G/plots";
//TString outputPath="./results/26Sep_G_bad/plots";
TString outputPath="./results/22Aug_MC_HIP_wrtBCD_61mb/plots";
//TString outputPath="./results/22Aug_MC_HIP_wrtEF_65mb_brilcac/plots";
//TString outputPath="./results/22Aug_DataMC_HIPcheck/plots/EFHIP";
//TString outputPath="./results/22Aug_DataMC_HIPcheck/plots/EFnoHIP";
//TString outputPath="./results/22Aug_DataMC_HIPcheck/plots/BCDnoHIP";
//TString outputPath="./results/22Aug_DataMC_HIPcheck/plots/BCDHIP";

//TString outputPath="./results/19July_ICHEP_9fb_v2/AN";
//TString outputPath="./results/19July_ICHEP_9fb_v4_69p735mb/AN";
//TString outputPath="./results/19July_ICHEP_9fb_v4_69mb/AN";
//TString outputPath="./results/19July_ICHEP_9fb_v4/AN";
//TString outputPath="./results/19July_ICHEP_9fb_v3/AN";
//TString outputPath="./results/19July_ICHEP_9fb_v1/AN";
//TString outputPath="./results/21June_2fb/AN";
//TString outputPath="./results/21June_2fb_69p735mb/AN";
//TString outputPath="./results/06June_804pb_trgEff_pu71mb/AN";
//TString outputPath="./results/06June_trgEff2_pu71mb/AN";
//TString outputPath="./results/06June_pu_71mb/AN";
//TString outputPath="./results/06June_trgEff2_noJER/AN";
//TString outputPath="./results/06June_trgEff_noJER/AN";
//TString outputPath="./results/06June_trgEff/AN";
//TString outputPath="./results/06June_JER/AN";
//TString outputPath="./results/05June_589pb_puNoDYSF/AN";
//TString outputPath="./results/05June_589pb_pu/AN";
//TString outputPath="./results/05June_589pb/pdf/AN";
//TString outputPath="./results/26May_PromptReco/pdf/AN";
//TString outputPath="./results/26May_PromptReco/pdf";
...
void DrawTTbar(TString name, TString histotitle, int jettype, bool log=0, int move_legend=0);
...
bool Draw_newdiscriminator_plots, bool Draw_tagRate_plots, bool Draw_2D_plots)
{
  ...
  TString action = "mkdir "+outputPath;
  system(action);
  ...
  //ALPHA
  DrawTTbar("njet" ,     "number of jes", 0); 
  DrawTTbar("njet_pt30" ,"number of jes", 0); 
...
void Draw(TString name, TString histotitle, bool log, int move_legend)
{
 ...
 c1->SaveAs(outputPath+"/"+name_plot1);
 c1->SaveAs(outputPath+"/"+name_plot2);
 //c1->SaveAs("results/02May_test/Commissioning_plots_JetPt20/"+name_plot1);
 //c1->SaveAs("ttbar/"+name_plot1);
 //c1->SaveAs("results/02May_test/Commissioning_plots_JetPt20/"+name_plot2);
...
void DrawTTbar(TString name, TString histotitle, int jettype, bool log, int move_legend ) 
{
 ...
 Lumititle= LumititleTTBar;
 if( jettype == 0 )
    Jettypetitle="AK4 jets (p_{T} > 20 GeV)";
 else
...
void Draw2DPlot(TString name, TString histotitle, TString titleX, TString titleY, bool log)
{
 ...
 TProfile * pro_data = hist_data->ProfileX();
  ...
  TString name_plot2=name+"_Linear"+format2;
  if(log) name_plot2=name+"_Log"+format2;
  canvas->SaveAs(outputPath+"/"+name_plot1);
  canvas->SaveAs(outputPath+"/"+name_plot2);
