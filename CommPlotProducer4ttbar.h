...
public :
   ...
   Float_t         CTag_Jet_CvsB[1000];   //[nJet] //ALPHA
   Float_t         CTag_Jet_CvsL[1000];   //[nJet] //ALPHA
...
void CommPlotProducer4ttbar::Init(TChain *tree)
{
  ...
  if (produceNewAlgoTree) {
   ...
   TString puWgtUrl("/afs/cern.ch/work/j/jtsai/BTagging/commissioning/CMSSW_8_0_5_patch1/src/RecoBTag/PerformanceMeasurements/test/BTagAnalyzerMacros/BTaggingCommission/json/pileupWgts.root");
