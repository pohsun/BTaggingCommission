...
public :
  ...
  TBranch *b_SV_vtx_phi;
   ...
   CommPlotProducer4ttbar(TChain *supertree=0, bool infotree1=true, bool infotree2=true, bool infotreeCTag=false, TString puWgtUrlName="${CMSSW_BASE}/src/RecoBTag/PerformanceMeasurements/test/ttbar/data/pileupWgts" );
   CommPlotProducer4ttbar(TChain &supertree, bool infotree1=true, bool infotree2=true, bool infotreeCTag=false, TString puWgtUrlName="${CMSSW_BASE}/src/RecoBTag/PerformanceMeasurements/test/ttbar/data/pileupWgts.root");
...
CommPlotProducer4ttbar::CommPlotProducer4ttbar(TChain *superTree, bool infotree1, bool infotree2, bool infotreeCTag, TString puWgtUrlName)
{  
   numb_histo = 0;
   numb_histo2 = 0;
   numb_histo2D = 0;
   ...
   puWgtUrl = puWgtUrlName;
   Init(superTree);
}

CommPlotProducer4ttbar::CommPlotProducer4ttbar(TChain &superTree, bool infotree1, bool infotree2, bool infotreeCTag, TString puWgtUrlName)
{
    CommPlotProducer4ttbar(&superTree, infotree1, infotree2, infotreeCTag, puWgtUrlName);
}
