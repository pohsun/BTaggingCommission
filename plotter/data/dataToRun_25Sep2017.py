...
defalutPUWgtUrl="/afs/cern.ch/work/p/pchen/public/btaggingCommRun2/prod/20170925_Summer17MC/CMSSW_9_2_7_patch1/src/RecoBTag/PerformanceMeasurements/test/ttbar/25Sep2017_DATA/merged_puWgtXsec69000.root"
...
groupdata['data'] = {
    'lumi'      : -1,
    'dataset'   : ['runB_v2','runC_v1','runC_v2','runC_v3','runD_v1'],
    'xsec'      : [-1,-1,-1,-1,-1],
}
