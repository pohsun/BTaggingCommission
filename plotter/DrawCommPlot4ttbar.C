...
TString Jettypetitle="p_{T} > 20 GeV";
TString filename="ttbar/output_all.root";
TString output="Commissioning_plots/";
...
{//{{{
 ...
 myFile->cd();
 hist_b         = (TH1D*)gROOT->FindObject(name+"_b_mc");
 hist_c         = (TH1D*)gROOT->FindObject(name+"_c_mc");
 hist_pu        = (TH1D*)gROOT->FindObject(name+"_pu_mc");
 ...
 if (log && name == "DeepCSVb") stack->SetMaximum(2*10e7);
 if (log && name == "DeepCSVbb") stack->SetMaximum(2*10e7);
 if (log && name == "DeepCSVBDisc") stack->SetMaximum(2*10e7);
 if (log && name == "sv_flight3DSig"){
     stack->SetMinimum(1*3.5);
     stack->SetMaximum(1e7/10);
 }
 if (log && name == "JP"){
     stack->SetMinimum(100*2.5);
     stack->SetMaximum(5e6/10);
 }
 if (log && name == "cMVAv2"){
     stack->SetMinimum(100*2.5);
     stack->SetMaximum(5e6/10);
 ...
 if(name == "CSV")        stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "CSVv2") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "DeepCSVb") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "DeepCSVbb") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "DeepCSVBDisc") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "cMVAv2") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.04 units");
 else if(name == "track_IPs") stack    ->GetHistogram()->GetYaxis()->SetTitle("tracks / 0.7 units");
 else if(name == "sv_flight3DSig") stack    ->GetHistogram()->GetYaxis()->SetTitle("SVs / 1.6 units");
 else if(name == "tagvarCSV_vertexmass_cat0") stack    ->GetHistogram()->GetYaxis()->SetTitle("SVs / 0.16 GeV");
 else if(name == "JP") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.05 units");
 else if(name == "JBP") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.16 units");
 else if(name == "SoftMu") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else if(name == "SoftEl") stack    ->GetHistogram()->GetYaxis()->SetTitle("jets / 0.02 units");
 else                      stack    ->GetHistogram()->GetYaxis()->SetTitle(TString::Format("Events /%.1f units",stack->GetHistogram()->GetXaxis()->GetBinWidth(1)).Data());
 ...
 latex = new TLatex(0.20, 0.82, Selectiontitle);
 latex->SetNDC();
 latex->SetTextAlign(13);
 latex->SetTextFont(42); //22
 ...
 latex = new TLatex(0.20, 0.74, Jettypetitle);
 latex->SetNDC();
 latex->SetTextAlign(13);
 latex->SetTextFont(42); //22
 latex->SetTextSize(0.055);
